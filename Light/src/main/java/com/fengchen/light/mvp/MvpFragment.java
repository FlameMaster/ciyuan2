 ...
 * ============================================================
 */
public abstract class NxoaFragment<P extends BasePresenter, DB extends ViewDataBinding>
...
//        dialog.show();
    ...
    public void changeLoadingState(int code, String message) {
        ...
        if (code == EmptyState.NET_ERROR) {
            ...
            mLoadingView.findViewById(R.id.refresh).setOnClickListener(v -> getPresenter().onRefresh());
        }
    }
    ...
    public void showProcess(String message) {
        if (mLoadDialog == null) {
            mLoadDialog = new LoadDialog(getActivity(),R.style.NxDialog3);
...
/////////////////////////////////////校验相关/////////////////////////////////////////
    ...
    public void showCheckView(DialogCheckBuilder builder) {
        if (getActivity() instanceof NxoaActivity) {
            NxoaActivity acitvity = (NxoaActivity) getActivity();
